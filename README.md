...
## 🎉 Updates 🎉
   ...
   - We reproduced the network files of [SFANet](https://ieeexplore.ieee.org/abstract/document/9583294) (Stage-Aware Feature Alignment Network for Real-Time Semantic Segmentation of Street Scenes) and [MGSeg](https://ieeexplore.ieee.org/abstract/document/9511235) (MGSeg: Multiple Granularity-Based Real-Time Semantic Segmentation Network) for comparison with them. (Aug/16/2022)
